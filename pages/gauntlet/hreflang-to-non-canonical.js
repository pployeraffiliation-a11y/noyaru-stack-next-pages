  ...
  return (
    <main>
      <Head>
        ...
        <meta name="description" content="Page de test du parcours d'obstacles Noyaru, avec un focus sur un point précis pour le crawl." />
        ...
        <meta name="twitter:description" content="Page de test du parcours d'obstacles Noyaru, avec un focus sur un point précis pour le crawl." />
