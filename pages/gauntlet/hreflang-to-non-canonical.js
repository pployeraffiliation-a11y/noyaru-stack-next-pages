  ...
  return (
    <main>
      <Head>
        ...
        <title>Hreflang vers non canonique - Parcours d'obstacles Noyaru</title>
        <meta name="description" content="Cette page illustre un cas de hreflang vers une page non canonique, soulignant les défis spécifiques rencontrés lors du crawl." />
        ...
        <meta property="og:description" content="Cette page illustre un cas de hreflang vers une page non canonique, soulignant les défis spécifiques rencontrés lors du crawl." />
        ...
        <meta name="twitter:description" content="Cette page illustre un cas de hreflang vers une page non canonique, soulignant les défis spécifiques rencontrés lors du crawl." />
