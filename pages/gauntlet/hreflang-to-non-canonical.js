  ...
  return (
    <main>
      <Head>
        ...
        <title>Hreflang vers une page non canonique dans le parcours Noyaru</title>
        <meta name="description" content="Cette page du parcours d'obstacles illustre un cas de hreflang vers une page non canonique, soulignant une anomalie spécifique pour le crawl." />
        ...
        <meta property="og:description" content="Cette page du parcours d'obstacles illustre un cas de hreflang vers une page non canonique, soulignant une anomalie spécifique pour le crawl." />
        ...
        <meta name="twitter:description" content="Cette page du parcours d'obstacles illustre un cas de hreflang vers une page non canonique, soulignant une anomalie spécifique pour le crawl." />
