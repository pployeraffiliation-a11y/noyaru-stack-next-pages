  ...
  return (
    <main>
      <Head>
        ...
        <meta name="description" content="Cette page du parcours d'obstacles traite des hreflangs pointant vers des pages non canoniques, soulignant les implications pour le crawl." />
        ...
        <meta property="og:description" content="Cette page du parcours d'obstacles traite des hreflangs pointant vers des pages non canoniques, soulignant les implications pour le crawl." />
        ...
        <meta name="twitter:description" content="Cette page du parcours d'obstacles traite des hreflangs pointant vers des pages non canoniques, soulignant les implications pour le crawl." />
