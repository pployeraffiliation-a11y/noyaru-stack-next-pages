  ...
  return (
    <main>
      <Head>
        ...
        <meta name="description" content="Cette page traite des problèmes de hreflang invalid dans le parcours d'obstacles, illustrant une anomalie spécifique pour le crawl." />
