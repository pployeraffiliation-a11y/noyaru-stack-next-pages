  ...
  return (
    <main>
      <Head>
        ...
        <meta name="description" content="Cette page du parcours d'obstacles Noyaru illustre un cas de hreflang invalid, où le code de langue est mal formé, pour une meilleure compréhension des" />
