  ...
  return (
    <main>
      <Head>
        ...
        <meta name="description" content="Cette page traite des erreurs hreflang dans le parcours d'obstacles, illustrant un cas spécifique de code de langue mal formé." />
