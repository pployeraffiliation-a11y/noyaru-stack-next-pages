  ...
  return (
    <main>
      <Head>
        ...
        <meta property="og:title" content="Parcours d'obstacles Noyaru - Hreflang Invalid" />
        ...
        <meta name="twitter:title" content="Parcours d'obstacles Noyaru - Hreflang Invalid" />
