  ...
  return (
    <main>
      <Head>
        ...
        <title>Page de test unique pour le parcours d'obstacles</title>
        ...
        <meta property="og:title" content="Page de test unique pour le parcours d'obstacles" />
        ...
        <meta name="twitter:title" content="Page de test unique pour le parcours d'obstacles" />
