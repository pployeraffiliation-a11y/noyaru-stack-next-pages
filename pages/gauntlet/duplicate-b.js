  ...
  return (
    <main>
      <Head>
        ...
        <title>Page duplicate B : un cas unique dans le parcours d'obstacles</title>
        <meta name="description" content="Cette page illustre un cas unique dans le parcours d'obstacles, mettant en avant une anomalie spécifique." />
        <link rel="canonical" href="https://noyaru-stack-next-pages.netlify.app/gauntlet/duplicate-b" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Page duplicate B : un cas unique dans le parcours d'obstacles" />
        ...
        <meta name="twitter:title" content="Page duplicate B : un cas unique dans le parcours d'obstacles" />
