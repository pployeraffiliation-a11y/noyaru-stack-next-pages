  ...
  return (
    <main>
      <Head>
        ...
        <title>Test de parcours d'obstacles : duplicate b</title>
        <meta name="description" content="Cette page illustre le cas de duplicate b dans le parcours d'obstacles, mettant en avant une anomalie spécifique pour le test." />
        <link rel="canonical" href="https://noyaru-stack-next-pages.netlify.app/gauntlet/duplicate-b" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Test de parcours d'obstacles : duplicate b" />
        ...
        <meta name="twitter:title" content="Test de parcours d'obstacles : duplicate b" />
