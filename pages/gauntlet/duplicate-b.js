  ...
  return (
    <main>
      <Head>
        ...
        <title>Test de doublon pour la page duplicate-b du parcours</title>
        <meta name="description" content="Cette page duplicate-b du parcours d'obstacles illustre un cas de doublon pour le test SEO, avec une description unique et pertinente." />
