  ...
  return (
    <main>
      <Head>
        ...
        <meta name="description" content="Une meta description volontairement longue pour déclencher la famille des descriptions sur une page non indexable en 2023." />
