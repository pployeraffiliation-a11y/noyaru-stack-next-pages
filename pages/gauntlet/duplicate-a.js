  ...
  return (
    <main>
      <Head>
        ...
        <meta name="description" content="Cette page illustre un cas de doublon dans le parcours d'obstacles, unique en son genre." />
        <link rel="canonical" href="https://noyaru-stack-next-pages.netlify.app/gauntlet/duplicate-a" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Test de parcours d'obstacles : page duplicate A" />
        ...
        <meta name="twitter:title" content="Test de parcours d'obstacles : page duplicate A" />
