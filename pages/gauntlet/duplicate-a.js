  ...
  return (
    <main>
      <Head>
        ...
        <title>Test de duplication dans le parcours d'obstacles Noyaru</title>
        <meta name="description" content="Cette page illustre un cas de duplication dans le parcours d'obstacles, avec des tests spécifiques pour les anomalies SEO." />
        <link rel="canonical" href="https://noyaru-stack-next-pages.netlify.app/gauntlet/duplicate-a" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Test de duplication dans le parcours d'obstacles Noyaru" />
        ...
        <meta name="twitter:title" content="Test de duplication dans le parcours d'obstacles Noyaru" />
