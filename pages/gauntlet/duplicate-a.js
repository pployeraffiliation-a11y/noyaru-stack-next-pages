  ...
  return (
    <main>
      <Head>
        ...
        <meta name="description" content="Cette page illustre un cas de doublon dans le parcours d'obstacles, mettant en avant les défis rencontrés lors de la navigation." />
