  ...
  return (
    <main>
      <Head>
        ...
        <meta name="description" content="Découvrez le parcours d'obstacles avec un double slash, une page dédiée à une anomalie spécifique pour la famille visée lors du crawl." />
