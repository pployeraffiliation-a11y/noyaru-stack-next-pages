  ...
  return (
    <main>
      <Head>
        ...
        <title>Double Slash dans les URL - Parcours d'obstacles Noyaru</title>
        <meta name="description" content="Découvrez le parcours d'obstacles Noyaru, une expérience unique qui met en avant les défis du double slash dans les URL." />
        <link rel="canonical" href="https://noyaru-stack-next-pages.netlify.app/gauntlet/double-slash" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Double Slash dans les URL - Parcours d'obstacles Noyaru" />
        ...
        <meta name="twitter:title" content="Double Slash dans les URL - Parcours d'obstacles Noyaru" />
