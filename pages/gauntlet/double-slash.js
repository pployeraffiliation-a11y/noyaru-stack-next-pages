  ...
  return (
    <main>
      <Head>
        ...
        <title>Double Slash : Anomalie dans le parcours d'obstacles Noyaru</title>
        <meta name="description" content="Découvrez le parcours d'obstacles avec un double slash, une anomalie unique à explorer pour la famille visée lors du crawl." />
        <link rel="canonical" href="https://noyaru-stack-next-pages.netlify.app/gauntlet/double-slash" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Double Slash : Anomalie dans le parcours d'obstacles Noyaru" />
        ...
        <meta name="twitter:title" content="Double Slash : Anomalie dans le parcours d'obstacles Noyaru" />
