...
export default function Page() {
  return (
    <main>
      <Head>
        <meta name="description" content="Cette page traite du parcours d'obstacles Noyaru, illustrant le cas d'une meta description manquante." />
        ...
        <meta property="og:description" content="Cette page traite du parcours d'obstacles Noyaru, illustrant le cas d'une meta description manquante." />
        ...
        <meta name="twitter:description" content="Cette page traite du parcours d'obstacles Noyaru, illustrant le cas d'une meta description manquante." />
